...
//     final assignmentDetails = await dbHelper.getAssignment(assignment);
//     final assignmentId = assignment['id'].toString();
//     schedules[assignmentId] = assignmentDetails;
...
//     final lectureDay = assignment['lecture_day'];
//     final lectureStartTime = assignment['lecture_start_time'];
//     final lectureEndTime = assignment['lecture_end_time'];
//     final laboratoryDay = assignment['laboratory_day'];
//     final laboratoryStartTime = assignment['laboratory_start_time'];
//     final laboratoryEndTime = assignment['laboratory_end_time'];
...
//     print('type: $type');
//     print('maxLoad: ---------------------------------------------------------');
//     print('lectureDay: $lectureDay');
//     print('lectureStartTime: $lectureStartTime');
//     print('lectureEndTime: $lectureEndTime');
//     print('maxLoad: ---------------------------------------------------------');
//     print('laboratoryDay: $laboratoryDay');
//     print('laboratoryStartTime: $laboratoryStartTime');
//     print('laboratoryEndTime: $laboratoryEndTime');
//     // Print other details similarly
//   }

//   // Print the data
//   // print('Lecture Rooms: $lecRoom');
//   // print('Laboratory Rooms: $labRoom');
