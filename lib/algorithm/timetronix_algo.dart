...
// final Map<int, List<Map<String, dynamic>>> assignmentsByCourse = {};
// String getDay = '';
// String getStartTime = '';
// String getEndTime = '';
// //lecture
...
//   // Fetch lecture and laboratory rooms
...
//   // Fetch assignment details for each assignment and save the data
...
//     //print(assignmentsByCourse);
//   }

//   // Print details for each course
//   for (final courseId in assignmentsByCourse.keys) {
//     final facultyId = assignmentsByCourse[courseId]?[0]['faculty_id'];
//     final assignmentDetails =
//         await dbHelper.getAssignmentDetails(facultyId, courseId);

//     final facultyFirstname = assignmentDetails['faculty_firstname'];
//     final facultyLastname = assignmentDetails['faculty_lastname'];
//     final minLoad = assignmentDetails['min_load'];
//     final maxLoad = assignmentDetails['max_load'];
//     final priorityNumber = assignmentDetails['priority_number'];
//     final course = assignmentDetails['course'];
//     final description = assignmentDetails['description'];
//     final year = assignmentDetails['year'];
//     final semester = assignmentDetails['semester'];
//     final units = assignmentDetails['units'];
//     final meeting = assignmentDetails['meeting'];
//     final hasLab = assignmentDetails['hasLab'];

//     //print('faculty id = ${assignmentsByCourse[courseId]?[0]['faculty_id']}');
//     print('faculty name: $facultyLastname, $facultyFirstname');
//     // print('minLoad: $minLoad');
//     // print('maxLoad: $maxLoad');
//     print('priorityNumber: $priorityNumber');
//     print('---------------------------------------------------------');
...
//     print('hasLab: $hasLab');
//     for (final assignment in assignmentsByCourse[courseId]!) {
//       // print(
//       //   'classroom id: ${assignment['classroom_id']}',
//       // );
//       // print(
//       //   'day: ${assignment['day']}| start time: ${assignment['start_time']} - end time: ${assignment['end_time']}',
//       // );
//       if (counter == 0) {
//         lecDay = assignment['day'];
//         lecStartTime = assignment['start_time'];
//         lecEndTime = assignment['end_time'];
//         counter++;
//       } else {
//         labDay = assignment['day'];
//         labStartTime = assignment['start_time'];
//         labEndTime = assignment['end_time'];
//         counter = 0;
//       }
//     }
//     print(
//       'day: $lecDay| start time: $lecStartTime - end time: $lecEndTime',
//     );
//     if (hasLab == 'YES') {
//       print(
//         'day: $labDay| start time: $labStartTime - end time: $labEndTime',
//       );
//     }
//     // Save details to separate variables
//     // final facultyFirstname = assignmentDetails['faculty_firstname'];
//     // final facultyLastname = assignmentDetails['faculty_lastname'];
//     // final minLoad = assignmentDetails['min_load'];
//     // final maxLoad = assignmentDetails['max_load'];
...
//     // final meeting = assignmentDetails['meeting'];
//     // final hasLab = assignmentDetails['hasLab'];
//     // final room = assignmentDetails['room'];
//     // final type = assignmentDetails['type'];

//     // final day = assignmentDetails['day'];
//     // final starTime = assignmentDetails['start_time'];
//     // final endTime = assignmentDetails['end_time'];

//     // print(assignmentDetails);

//     // Now you can use these variables as needed
//     // For example, print them or use them in further processing
//     // print('Faculty: $facultyFirstname $facultyLastname');
//     // print('minLoad: $minLoad');
//     // print('maxLoad: $maxLoad');
//     // print('priorityNumber: $priorityNumber');
//     // print('---------------------------------------------------------');
...
// // //   // print("course_assignments: $courseAssignments");
